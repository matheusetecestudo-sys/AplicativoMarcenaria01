        ...
        <div className="w-full h-full pb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 lg:sticky lg:top-4 animate-fade-in-up stagger-4">
                    <div className="bg-white/80 dark:bg-[#1A1A1A]/80 border-4 border-primary p-0 shadow-[0_20px_60px_rgba(0,0,0,0.2)] dark:shadow-[0_20px_60px_rgba(255,255,255,0.05)] transition-all relative overflow-hidden flex flex-col glass glow-blue">

                        {/* Receipt Header */}
                        <div className="bg-primary p-5 text-center border-b-4 border-black dark:border-white">
                            <h2 className="text-white text-xl font-black uppercase tracking-[0.2em] flex items-center justify-center gap-2">
                                <span className="material-symbols-outlined">receipt_long</span>
                                ESTIMATIVA TECH
                            </h2>
                        </div>

                        <div className="p-8 flex flex-col gap-6 relative bg-white/50 dark:bg-[#111]/50 [background-image:radial-gradient(#ccc_1px,transparent_1px)] dark:[background-image:radial-gradient(#333_1px,transparent_1px)] [background-size:20px_20px]">
